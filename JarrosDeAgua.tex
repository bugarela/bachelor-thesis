...
% \begin{document}
\tlatex
\@x{}\moduleLeftDash\@xx{ {\MODULE} JarrosDeAgua}\moduleRightDash\@xx{}%
\@x{ {\EXTENDS} Integers}%
\@x{ {\VARIABLES} jarro\_pequeno ,\, jarro\_grande}%
\@x{ TypeOK \.{\defeq} \.{\land} jarro\_pequeno \.{\in} 0 \.{\dotdot} 3}%
\@x{\@s{56.14} \.{\land} jarro\_grande\@s{8.2} \.{\in} 0 \.{\dotdot} 5}%
\@x{ Init \.{\defeq} \.{\land} jarro\_grande\@s{8.2} \.{=} 0}%
\@x{\@s{35.70} \.{\land} jarro\_pequeno \.{=} 0}%
\@x{ EncheJarroPequeno \.{\defeq} \.{\land} jarro\_pequeno \.{'} \.{=} 3}%
\@x{\@s{105.80} \.{\land} jarro\_grande \.{'}\@s{8.2} \.{=} jarro\_grande}%
 \@x{ EncheJarroGrande \.{\defeq} \.{\land} jarro\_grande \.{'}\@s{8.2} \.{=}
 5}%
\@x{\@s{101.63} \.{\land} jarro\_pequeno \.{'} \.{=} jarro\_pequeno}%
\@x{ EsvaziaJarroPequeno \.{\defeq} \.{\land} jarro\_pequeno \.{'} \.{=} 0}%
\@x{\@s{111.93} \.{\land} jarro\_grande \.{'}\@s{8.2} \.{=} jarro\_grande}%
 \@x{ EsvaziaJarroGrande \.{\defeq} \.{\land} jarro\_grande \.{'}\@s{8.2}
 \.{=} 0}%
\@x{\@s{107.76} \.{\land} jarro\_pequeno \.{'} \.{=} jarro\_pequeno}%
 \@x{ JarroPequenoParaJarroGrande \.{\defeq} {\IF} jarro\_grande \.{+}
 jarro\_pequeno \.{\leq} 5}%
 \@x{\@s{155.19} \.{\THEN} \.{\land} jarro\_grande \.{'}\@s{8.2} \.{=}
 jarro\_grande \.{+} jarro\_pequeno}%
\@x{\@s{186.50} \.{\land} jarro\_pequeno \.{'} \.{=} 0}%
\@x{\@s{155.19} \.{\ELSE} \.{\land} jarro\_grande \.{'}\@s{8.2} \.{=} 5}%
 \@x{\@s{186.50} \.{\land} jarro\_pequeno \.{'} \.{=} jarro\_pequeno \.{-} ( 5
 \.{-} jarro\_grande )}%
 \@x{ JarroGrandeParaJarroPequeno\@s{0.12} \.{\defeq} {\IF} jarro\_grande
 \.{+} jarro\_pequeno \.{\leq} 3}%
\@x{\@s{155.19} \.{\THEN} \.{\land} jarro\_grande \.{'}\@s{8.2} \.{=} 0}%
 \@x{\@s{186.50} \.{\land} jarro\_pequeno \.{'} \.{=} jarro\_grande \.{+}
 jarro\_pequeno}%
 \@x{\@s{155.19} \.{\ELSE} \.{\land} jarro\_grande \.{'}\@s{8.2} \.{=}
 jarro\_pequeno \.{-} ( 3 \.{-} jarro\_grande )}%
\@x{\@s{186.50} \.{\land} jarro\_pequeno \.{'} \.{=} 3}%
\@x{ Next \.{\defeq} \.{\lor} EncheJarroPequeno}%
\@x{\@s{39.83} \.{\lor} EncheJarroGrande}%
\@x{\@s{39.83} \.{\lor} EsvaziaJarroPequeno}%
\@x{\@s{39.83} \.{\lor} EsvaziaJarroGrande}%
\@x{\@s{39.83} \.{\lor} JarroPequenoParaJarroGrande}%
\@x{\@s{39.83} \.{\lor} JarroGrandeParaJarroPequeno}%
\@x{}\bottombar\@xx{}%
% \end{document}
