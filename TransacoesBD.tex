...
\begin{document}
\tlatex
\@x{}\moduleLeftDash\@xx{ {\MODULE} TransacoesBD}\moduleRightDash\@xx{}%
\@x{ {\CONSTANT} GR}%
\@pvspace{8.0pt}%
\@x{ {\VARIABLE} estadoGR}%
\@x{}\midbar\@xx{}%
\@x{ TBDTypeOK \.{\defeq}}%
 \@x{\@s{8.2} estadoGR \.{\in} [ GR \.{\rightarrow} \{\@w{trabalhando}
 ,\,\@w{preparado} ,\,\@w{cometido} ,\,\@w{abortado} \} ]}%
\@pvspace{8.0pt}%
 \@x{ TBDInit \.{\defeq} estadoGR \.{=} [ g \.{\in} GR
 \.{\mapsto}\@w{trabalhando} ]}%
\@pvspace{8.0pt}%
 \@x{ podeCometer\@s{0.96} \.{\defeq} \A\, g\@s{10.48} \.{\in} GR \.{:}
 estadoGR [ g ] \.{\in} \{\@w{preparado} ,\,\@w{cometido} \}}%
\@pvspace{8.0pt}%
 \@x{ naoCometido \.{\defeq} \A\, g\@s{10.48} \.{\in} GR \.{:} estadoGR [ g ]
 \.{\neq}\@w{cometido}}%
\@pvspace{8.0pt}%
\@x{ Prepara ( g ) \.{\defeq} \.{\land} estadoGR [ g ] \.{=}\@w{trabalhando}}%
 \@x{\@s{66.53} \.{\land} estadoGR \.{'} \.{=} [ estadoGR {\EXCEPT} {\bang} [
 g ] \.{=}\@w{preparado} ]}%
\@pvspace{8.0pt}%
 \@x{ Decide ( g )\@s{4.61} \.{\defeq} \.{\lor} \.{\land} estadoGR [ g ]
 \.{=}\@w{preparado}}%
\@x{\@s{77.64} \.{\land} podeCometer}%
 \@x{\@s{77.64} \.{\land} estadoGR \.{'} \.{=} [ estadoGR {\EXCEPT} {\bang} [
 g ] \.{=}\@w{cometido} ]}%
 \@x{\@s{66.53} \.{\lor} \.{\land} estadoGR [ g ] \.{\in} \{\@w{trabalhando}
 ,\,\@w{preparado} \}}%
\@x{\@s{77.64} \.{\land} naoCometido}%
 \@x{\@s{77.64} \.{\land} estadoGR \.{'} \.{=} [ estadoGR {\EXCEPT} {\bang} [
 g ] \.{=}\@w{abortado} ]}%
\@pvspace{8.0pt}%
 \@x{ TBDNext \.{\defeq} \E\, g \.{\in} GR \.{:} Prepara ( g ) \.{\lor} Decide
 ( g )}%
\@x{}\midbar\@xx{}%
\@x{ TBDConsistente \.{\defeq}}%
 \@x{\@s{8.2} \A\, r1 ,\, r2 \.{\in} GR \.{:} {\lnot} \.{\land} estadoGR [ r1
 ] \.{=}\@w{abortado}}%
\@x{\@s{85.86} \.{\land} estadoGR [ r2 ] \.{=}\@w{cometido}}%
\@x{}\midbar\@xx{}%
\@pvspace{8.0pt}%
\@x{ TBDSpec \.{\defeq} TBDInit \.{\land} {\Box} [ TBDNext ]_{ estadoGR}}%
\@pvspace{8.0pt}%
 \@x{ {\THEOREM} TBDSpec \.{\implies} {\Box} ( TBDTypeOK \.{\land}
 TBDConsistente )}%
\@pvspace{8.0pt}%
\@x{}\bottombar\@xx{}%
\end{document}
