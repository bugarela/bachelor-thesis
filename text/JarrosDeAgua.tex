...
\@x{\@s{56.14} \.{\land} jarro\_grande\@s{5.11} \.{\in} 0 \.{\dotdot} 5}%
\@pvspace{8.0pt}%
\@x{ Init \.{\defeq} \.{\land} jarro\_grande\@s{8.2} \.{=} 0}%
\@x{\@s{35.70} \.{\land} jarro\_pequeno \.{=} 0}%
\@pvspace{8.0pt}%
\@x{ EnchePequeno \.{\defeq} \.{\land} jarro\_pequeno \.{'} \.{=} 3}%
\@x{\@s{82.40} \.{\land} jarro\_grande \.{'}\@s{5.11} \.{=} jarro\_grande}%
\@pvspace{8.0pt}%
\@x{ EncheGrande \.{\defeq} \.{\land} jarro\_grande \.{'}\@s{5.11} \.{=} 5}%
\@x{\@s{78.24} \.{\land} jarro\_pequeno \.{'} \.{=} jarro\_pequeno}%
\@pvspace{8.0pt}%
\@x{ EsvaziaPequeno \.{\defeq} \.{\land} jarro\_pequeno \.{'} \.{=} 0}%
\@x{\@s{88.54} \.{\land} jarro\_grande \.{'}\@s{5.11} \.{=} jarro\_grande}%
\@pvspace{8.0pt}%
\@x{ EsvaziaGrande \.{\defeq} \.{\land} jarro\_grande \.{'}\@s{5.11} \.{=} 0}%
\@x{\@s{84.37} \.{\land} jarro\_pequeno \.{'} \.{=} jarro\_pequeno}%
\@pvspace{8.0pt}%
 \@x{ PequenoParaGrande \.{\defeq} {\IF} jarro\_grande \.{+} jarro\_pequeno
 \.{\leq} 5}%
 \@x{\@s{108.40} \.{\THEN} \.{\land} jarro\_grande \.{'}\@s{5.11} \.{=}
 jarro\_grande \.{+} jarro\_pequeno}%
\@x{\@s{139.71} \.{\land} jarro\_pequeno \.{'} \.{=} 0}%
\@x{\@s{108.40} \.{\ELSE} \.{\land} jarro\_grande \.{'}\@s{5.11} \.{=} 5}%
 \@x{\@s{139.71} \.{\land} jarro\_pequeno \.{'} \.{=} jarro\_pequeno \.{-} ( 5
 \.{-} jarro\_grande )}%
\@pvspace{8.0pt}%
 \@x{ GrandeParaPequeno\@s{0.12} \.{\defeq} {\IF} jarro\_grande \.{+}
 jarro\_pequeno \.{\leq} 3}%
\@x{\@s{108.40} \.{\THEN} \.{\land} jarro\_grande \.{'}\@s{5.11} \.{=} 0}%
 \@x{\@s{139.71} \.{\land} jarro\_pequeno \.{'} \.{=} jarro\_grande \.{+}
 jarro\_pequeno}%
 \@x{\@s{108.40} \.{\ELSE} \.{\land} jarro\_grande \.{'}\@s{5.11} \.{=}
 jarro\_pequeno \.{-} ( 3 \.{-} jarro\_grande )}%
\@x{\@s{139.71} \.{\land} jarro\_pequeno \.{'} \.{=} 3}%
\@pvspace{8.0pt}%
\@x{ Next \.{\defeq} \.{\lor} EnchePequeno}%
\@x{\@s{39.83} \.{\lor} EncheGrande}%
\@x{\@s{39.83} \.{\lor} EsvaziaPequeno}%
\@x{\@s{39.83} \.{\lor} EsvaziaGrande}%
\@x{\@s{39.83} \.{\lor} PequenoParaGrande}%
\@x{\@s{39.83} \.{\lor} GrandeParaPequeno}%
\@x{}\bottombar\@xx{}%
\end{document}
